...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created: function () {
    ...
    // for IE11
    __WEBPACK_IMPORTED_MODULE_1__store___default.a.$on('GET_AJAX_COMPLETE', function () {
...
module.exports = new _vue2.default({
  ...
  methods: {
    ...
    get_data: function get_data(name) {
      ...
      var travelko_path = "<?php echo $FW_ENV['url']['WWW']; ?>";
...
var render = function() {
  ...
  return _c("div", [_c("div", { domProps: { innerHTML: _vm._s(_vm.result) } })])
}
var staticRenderFns = []
